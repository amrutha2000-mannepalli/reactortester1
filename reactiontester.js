...
var top;
var heightwidth;
left=Math.random() *300;//random number between 1 to 150
console.log(left)
top=Math.random() *300;
heightwidth=((Math.random() *500) +100);// random number between 100 to 300  where +100 means starting from min heightwidth 100
